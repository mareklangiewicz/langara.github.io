  ...
  var body = noh.div(
    noh.p(
      ...
      noh.ul(
        la("file:/sdcard/"),
        la("file:///sdcard/"),
        la(window.location.origin + window.location.pathname + "#Intent;task=start_service;action=MAREK_ACTION;data=some_marek_data;end"),
        la(window.location.origin + window.location.pathname + "#Intent;task=start_activity;action=MAREK_ACTION;data=some_marek_data;end"),
        la(window.location.origin + window.location.pathname + "#Intent;task=send_broadcast;action=MAREK_ACTION;data=some_marek_data;end"),
        la(window.location.origin + window.location.pathname + "#Intent;action=view;data=" + encodeURIComponent(GEOEX) + ";end"),
        la(window.location.origin + window.location.pathname + "#Intent;action=android.media.action.MEDIA_PLAY_FROM_SEARCH;data=" + encodeURIComponent(MP3EX) + ";end"),
        la(window.location.origin + window.location.pathname + "#Intent;action=set_alarm;end"),
        la(window.location.origin + window.location.pathname + "#Intent;action=view;data=http://www.google.pl;end"),
        la("http://mi#Intent;action=view;data=" + encodeURIComponent(GEOEX) + ";end"),
        la("mi://#Intent;action=view;data=" + encodeURIComponent(GEOEX) + ";end"),
...
function tests() {
  ...
  slow_log([
    ...
    "file://" + MP3EX,
    GEOEX,
    window.location.origin + window.location.pathname + "#Intent;action=view;data=" + encodeURIComponent(GEOEX) + ";end",
    window.location.origin + window.location.pathname + "#Intent;action=android.media.action.MEDIA_PLAY_FROM_SEARCH;data=" + encodeURIComponent(MP3EX) + ";end",
    window.location.origin + window.location.pathname + "#Intent;action=set_alarm;end",
    window.location.origin + window.location.pathname + "#Intent;action=view;data=http://www.google.pl;end",
    "http://mi#Intent;action=view;data=" + encodeURIComponent(GEOEX) + ";end",
    "mi://#Intent;action=view;data=" + encodeURIComponent(GEOEX) + ";end"
  ], 200);
}
